 ...
 */
public class MyEmpleadoRecyclerViewAdapter extends RecyclerView.Adapter<MyEmpleadoRecyclerViewAdapter.ViewHolder> {

    private final List<DummyItem> mValues;

    public MyEmpleadoRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
